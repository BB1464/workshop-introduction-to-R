...
footer:  "[Workshop on Introduction to R](https://github.com/BB1464/CascardiaRConf2022)"
logo: "img/ui.jpg"
css: logo.css
format: 
   revealjs: 
...
ggplot(data = plot_df, 
  ...
  annotate("text", x = 2018.25, y = -0.7, label = "MSc\n(Agrometeorology)",
           hjust = 0.5, family = "lato", size = 8, lineheight = 0.4, colour = "#5b868d") +
  # phd
  ...
  annotate("text", x = 2022.2, y = 0.95, label = "CocoaSoils\nIITA",
           hjust = 0.5, family = "lato", size = 8, lineheight = 0.4, colour = "#5b868d") +
  labs(x = "", y = "") +
  scale_fill_identity() +
