...
- Set the directry where you want to put the project.
...
::: {.column width="50%"}
![](img/code-chunk.png){style="float:right;padding: 0 0 0 10px;" fig-alt="Headshot of Dr. Maria Tackett" width="300"}
:::
:::
:::
