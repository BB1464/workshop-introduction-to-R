...
![](img/RlearningPath.png){.absolute top="100" right="100" width="530" height="530"}
...
## Learning Objectives Continued✍️✍️✍️
...
![](img/installation.png){.absolute top="100" right="100" width="550" height="550"}

## **Install R and R Studio**) {.test}
...
## RStudio Installation Cont. ) {.test}
...
## Pivot Longer Function from Tidyr
